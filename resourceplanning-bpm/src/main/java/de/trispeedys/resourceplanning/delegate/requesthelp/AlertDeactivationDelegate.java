...
import de.trispeedys.resourceplanning.messaging.AlertDeactivationMailTemplate;
...
public class AlertDeactivationDelegate extends RequestHelpNotificationDelegate
{
    public void execute(DelegateExecution execution) throws Exception
    {
        ...
        AlertDeactivationMailTemplate template = new AlertDeactivationMailTemplate(helper, getEvent(execution), position);
