...
public class ResourceDialog extends SpeedyFrame
{
    ...
    private PositionDTO selectedPositionToRemove;
    ...
    private void putListeners()
    {
        ...
        tbPosRemoving.getSelectionModel().addListSelectionListener(new ListSelectionListener()
        {
            public void valueChanged(ListSelectionEvent e)
            {
                int selectedRow = tbPosRemoving.getSelectedRow();
                if (selectedRow >= 0)
                {
                    int convertedRowIndex = tbPosRemoving.convertRowIndexToModel(selectedRow);
                    posToRemoveSelected(positionsToRemove.get(convertedRowIndex));
                }
            }
        });
    }
    ...
    private void posToRemoveSelected(PositionDTO positionDTO)
    {
        selectedPositionToRemove = positionDTO;
    }
    ...
    private void btnRemovePositionPressed(ActionEvent e)
    {
        AppSingleton.getInstance()
                .getPort()
                .removePositionFromEvent(selectedEvent.getEventId(), selectedPositionToRemove.getPositionNumber());
        JOptionPane.showMessageDialog(ResourceDialog.this, "Position '" +
                selectedPositionToRemove.getDescription() + "' wurde aus dem Event entfernt!!");
        selectedPositionToRemove = null;
        refreshTuningPositions();
    }
    ...
    private void initComponents()
    {
        ...
        contentPane.add(tbMain, new GridBagConstraints(0, 0, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        ...
        // ======== tdbMain ========
        {
            ...
            // ======== pnlPositions ========
            {
                ...
                // ======== borderEvents ========
                {
                    ...
                    borderEvents.add(scEvents, new GridBagConstraints(0, 0, 1, 4, 0.0, 0.0, GridBagConstraints.CENTER,
                ...
                pnlPositions.add(borderEvents, new GridBagConstraints(0, 2, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER,
            ...
            // ======== pnlHelper ========
            {
                ...
                pnlHelper.add(borderHelpers, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                        GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlManualAssignments ========
            {
                ...
                // ======== borderManualAssignments ========
                {
                    ...
                    borderManualAssignments.add(btnRefreshManualAssignments, new GridBagConstraints(1, 1, 1, 1, 0.0,
                ...
                // ======== borderAvailablePositions ========
                {
                    ...
                    borderAvailablePositions.add(btnReloadAvailablePositions, new GridBagConstraints(1, 0, 1, 1, 0.0,
                            0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
            ...
            // ======== pnlEventTuning ========
            {
                ...
                pnlEventTuning.add(tbTuning, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                        GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
            ...
            // ======== pnlMessages ========
            {
                ...
                pnlMessages.add(borderMessages, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                        GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
        ...
        contentPane.add(tdbMain, new GridBagConstraints(0, 1, 3, 2, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

        // ---- pgMain ----
        pgMain.setStringPainted(true);
        contentPane.add(pgMain, new GridBagConstraints(0, 3, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
                GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
