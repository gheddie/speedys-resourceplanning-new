...
public class ResourceDialog extends SpeedyFrame
{
    ...
    private void fillPostProcessing(Long eventId)
    {
        if (eventId != null)
        {
            treeTablePostProcessingSource.setModel(new TreeTableDataModel(ResourcePlanningClientRoutines.createDataStructure(eventId, true)));
            treeTablePostProcessingTarget.setModel(new TreeTableDataModel(ResourcePlanningClientRoutines.createDataStructure(eventId, false)));
        }
    }
    ...
    private void fillTree(Long eventId)
    {
        if (eventId != null)
        {
            treeTablePositions.setModel(new TreeTableDataModel(ResourcePlanningClientRoutines.createDataStructure(eventId, false)));
        }
        else
        {
            // show all events
    ...
    private void btnBookManuallyPressed(ActionEvent e)
    {
        ...
        String message = "Dem Helfer " + selectedManualAssignment.getHelperName() + " die freie Position " + selectedAvailablePosition.getDescription() + " zuweisen?";
    ...
    private void btnSwapPositionsPressed(ActionEvent e)
    {
        ...
        if ((!(sourceSwapNode.getEventItemType().equals(HierarchicalEventItemType.POSITION))) || (!(targetSwapNode.getEventItemType().equals(HierarchicalEventItemType.POSITION))))
        {
         ...
         * targetSwapNode.getEntityId(), selectedEvent.getEventId(), false); }
         */
        switch (result)
        {
            case JOptionPane.YES_OPTION:
                // ask helper --> start a process --> 'swapBySystem' = false
                AppSingleton.getInstance().getPort().swapPositions(sourceSwapNode.getEntityId(), targetSwapNode.getEntityId(), selectedEvent.getEventId(), false);
                break;
            case JOptionPane.NO_OPTION:
                // do NOT ask helper --> do NOT start a process --> 'swapBySystem' = true
                AppSingleton.getInstance().getPort().swapPositions(sourceSwapNode.getEntityId(), targetSwapNode.getEntityId(), selectedEvent.getEventId(), true);
                break;
            default:
                // do nothing
                break;
    ...
    private void btnExportEventPressed(ActionEvent e)
    {
        ...
        try
        {
            ...
            new EventExporter(selectedEvent.getEventId(), selectedEvent.getPositionCount(), selectedEvent.getAssignmentCount()).export(file.getAbsolutePath() +
    ...
    private void refreshTuningPositions()
    {
        ...
        // positions to add
        positionsToAdd = AppSingleton.getInstance().getPort().queryEventPositions(selectedEvent.getEventId(), false).getItem();

        tbPosAdding.setModel(TableModelBuilder.createGenericTableModel(positionsToAdd));
        // positions to remove
        positionsToRemove = AppSingleton.getInstance().getPort().queryEventPositions(selectedEvent.getEventId(), true).getItem();
    ...
    private void btnAddPositionPressed(ActionEvent e)
    {
        ...
        if (JOptionPane.showConfirmDialog(ResourceDialog.this, "Position(en) hinzufügen?", "Bestätigung", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
        {
            AppSingleton.getInstance().getPort().addPositionsToEvent(selectedEvent.getEventId(), ListMarshaller.marshall(retrievePosNumbers(selectedPositionsToAdd)));
    ...
    private void btnRemovePositionPressed(ActionEvent e)
    {
        ...
        if (JOptionPane.showConfirmDialog(ResourceDialog.this, "Position(en) löschen?", "Bestätigung", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
        {
            AppSingleton.getInstance().getPort().removePositionsFromEvent(selectedEvent.getEventId(), ListMarshaller.marshall(retrievePosNumbers(selectedPositionsToRemove)));
        ...
        // ======== tdbMain ========
        {
            ...
            // ======== pnlPositions ========
            {
                ...
                // ======== borderPositions ========
                {
                    ...
                    borderPositions.add(scPositions, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderPositions.add(btnRefreshTree, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlPositions.add(borderPositions, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                // ---- chkUnassignedOnly ----
                chkUnassignedOnly.setText("Nur unzugewiesene");
                pnlPositions.add(chkUnassignedOnly, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                ...
                // ======== borderEvents ========
                {
                    ...
                    borderEvents.add(btnPlanEvent, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderEvents.add(btnRefreshEvents, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderEvents.add(scEvents, new GridBagConstraints(0, 0, 1, 5, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderEvents.add(btnExportEvent, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderEvents.add(btnDuplicateEvent, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlPositions.add(borderEvents, new GridBagConstraints(0, 2, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlExecutions ========
            {
                ...
                ((GridBagLayout) pnlExecutions.getLayout()).columnWidths = new int[]
                {
                        0, 0
                };
                ((GridBagLayout) pnlExecutions.getLayout()).rowHeights = new int[]
                {
                        0, 0
                };
                ((GridBagLayout) pnlExecutions.getLayout()).columnWeights = new double[]
                {
                        1.0, 1.0E-4
                };
                ((GridBagLayout) pnlExecutions.getLayout()).rowWeights = new double[]
                {
                        1.0, 1.0E-4
                };
                ...
                // ======== borderExecutions ========
                {
                    ...
                    ((GridBagLayout) borderExecutions.getLayout()).columnWidths = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderExecutions.getLayout()).rowHeights = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderExecutions.getLayout()).columnWeights = new double[]
                    {
                            1.0, 0.0, 1.0E-4
                    };
                    ((GridBagLayout) borderExecutions.getLayout()).rowWeights = new double[]
                    {
                            0.0, 1.0, 1.0E-4
                    };
                    ...
                    borderExecutions.add(scExecutions, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderExecutions.add(btnRefreshExecutions, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlExecutions.add(borderExecutions, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlHelper ========
            {
                ...
                // ======== borderHelpers ========
                {
                    ...
                    borderHelpers.add(scHelpers, new GridBagConstraints(0, 0, 1, 3, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderHelpers.add(btnRefreshHelpers, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderHelpers.add(btnCreateHelper, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlHelper.add(borderHelpers, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlManualAssignments ========
            {
                ...
                // ======== borderManualAssignments ========
                {
                    ...
                    borderManualAssignments.add(scManualAssignments, new GridBagConstraints(0, 0, 1, 3, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderManualAssignments.add(btnBookManually, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderManualAssignments.add(btnRefreshManualAssignments, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0),
                            0, 0));
                }
                pnlManualAssignments.add(borderManualAssignments, new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                // ======== borderWish ========
                {
                    borderWish.setBorder(new TitledBorder("Helferwunsch"));
                    borderWish.setLayout(new GridBagLayout());
                    ((GridBagLayout) borderWish.getLayout()).columnWidths = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderWish.getLayout()).rowHeights = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderWish.getLayout()).columnWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ((GridBagLayout) borderWish.getLayout()).rowWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ...
                    borderWish.add(scWish, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
                }
                pnlManualAssignments.add(borderWish, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
                ...
                // ======== borderAvailablePositions ========
                {
                    ...
                    borderAvailablePositions.add(scAvailablePositions, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderAvailablePositions.add(btnReloadAvailablePositions, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0),
                            0, 0));
                }
                pnlManualAssignments.add(borderAvailablePositions, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlEventTuning ========
            {
                ...
                ((GridBagLayout) pnlEventTuning.getLayout()).columnWidths = new int[]
                {
                        0, 0
                };
                ((GridBagLayout) pnlEventTuning.getLayout()).rowHeights = new int[]
                {
                        0, 0, 0, 0
                };
                ((GridBagLayout) pnlEventTuning.getLayout()).columnWeights = new double[]
                {
                        1.0, 1.0E-4
                };
                ((GridBagLayout) pnlEventTuning.getLayout()).rowWeights = new double[]
                {
                        1.0, 0.0, 1.0, 1.0E-4
                };
                ...
                // ======== borderPosAdding ========
                {
                    ...
                    ((GridBagLayout) borderPosAdding.getLayout()).columnWidths = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderPosAdding.getLayout()).rowHeights = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderPosAdding.getLayout()).columnWeights = new double[]
                    {
                            1.0, 0.0, 1.0E-4
                    };
                    ((GridBagLayout) borderPosAdding.getLayout()).rowWeights = new double[]
                    {
                            0.0, 1.0, 1.0E-4
                    };
                    ...
                    borderPosAdding.add(scPosAdding, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderPosAdding.add(btnAddPosition, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlEventTuning.add(borderPosAdding, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                ...
                pnlEventTuning.add(tbTuning, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                // ======== borderPosRemoving ========
                {
                    borderPosRemoving.setBorder(new TitledBorder("Position entfernen"));
                    borderPosRemoving.setLayout(new GridBagLayout());
                    ((GridBagLayout) borderPosRemoving.getLayout()).columnWidths = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderPosRemoving.getLayout()).rowHeights = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderPosRemoving.getLayout()).columnWeights = new double[]
                    {
                            1.0, 0.0, 1.0E-4
                    };
                    ((GridBagLayout) borderPosRemoving.getLayout()).rowWeights = new double[]
                    {
                            0.0, 1.0, 1.0E-4
                    };
                    ...
                    borderPosRemoving.add(scPosRemoving, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderPosRemoving.add(btnRemovePosition, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlEventTuning.add(borderPosRemoving, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlMessages ========
            {
                ...
                ((GridBagLayout) pnlMessages.getLayout()).columnWidths = new int[]
                {
                        0, 0
                };
                ((GridBagLayout) pnlMessages.getLayout()).rowHeights = new int[]
                {
                        0, 0, 0
                };
                ((GridBagLayout) pnlMessages.getLayout()).columnWeights = new double[]
                {
                        1.0, 1.0E-4
                };
                ((GridBagLayout) pnlMessages.getLayout()).rowWeights = new double[]
                {
                        1.0, 1.0, 1.0E-4
                };
                ...
                // ======== borderMessages ========
                {
                    ...
                    ((GridBagLayout) borderMessages.getLayout()).columnWidths = new int[]
                    {
                            0, 0, 0
                    };
                    ((GridBagLayout) borderMessages.getLayout()).rowHeights = new int[]
                    {
                            0, 0, 0, 0
                    };
                    ((GridBagLayout) borderMessages.getLayout()).columnWeights = new double[]
                    {
                            1.0, 0.0, 1.0E-4
                    };
                    ((GridBagLayout) borderMessages.getLayout()).rowWeights = new double[]
                    {
                            0.0, 0.0, 1.0, 1.0E-4
                    };
                    ...
                    borderMessages.add(scMessages, new GridBagConstraints(0, 0, 1, 3, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderMessages.add(btnRefreshMessages, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                    ...
                    borderMessages.add(btnSendMessages, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                }
                pnlMessages.add(borderMessages, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                // ======== borderSingleMessage ========
                {
                    borderSingleMessage.setBorder(new TitledBorder("Gew\u00e4hlte Nachricht"));
                    borderSingleMessage.setLayout(new GridBagLayout());
                    ((GridBagLayout) borderSingleMessage.getLayout()).columnWidths = new int[]
                    {
                            0, 0, 0, 0
                    };
                    ((GridBagLayout) borderSingleMessage.getLayout()).rowHeights = new int[]
                    {
                            0, 0, 0, 0
                    };
                    ((GridBagLayout) borderSingleMessage.getLayout()).columnWeights = new double[]
                    {
                            0.0, 1.0, 0.0, 1.0E-4
                    };
                    ((GridBagLayout) borderSingleMessage.getLayout()).rowWeights = new double[]
                    {
                            0.0, 0.0, 1.0, 1.0E-4
                    };
                    ...
                    borderSingleMessage.add(lblRecipient, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

                    // ---- tfRecipient ----
                    tfRecipient.setEditable(false);
                    borderSingleMessage.add(tfRecipient, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
                    ...
                    borderSingleMessage.add(btnMessageFormat, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                    // ---- lblSubject ----
                    lblSubject.setText("Betreff:");
                    borderSingleMessage.add(lblSubject, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

                    // ---- tfSubject ----
                    tfSubject.setEditable(false);
                    borderSingleMessage.add(tfSubject, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
                    ...
                    borderSingleMessage.add(btnClipboard, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

                    // ---- lblBody ----
                    lblBody.setText("Text:");
                    borderSingleMessage.add(lblBody, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                    ...
                    borderSingleMessage.add(scBody, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
                }
                pnlMessages.add(borderSingleMessage, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            ...
            // ======== pnlPostProcessing ========
            {
                ...
                ((GridBagLayout) pnlPostProcessing.getLayout()).columnWidths = new int[]
                {
                        0, 0
                };
                ((GridBagLayout) pnlPostProcessing.getLayout()).rowHeights = new int[]
                {
                        0, 0, 0, 0
                };
                ((GridBagLayout) pnlPostProcessing.getLayout()).columnWeights = new double[]
                {
                        1.0, 1.0E-4
                };
                ((GridBagLayout) pnlPostProcessing.getLayout()).rowWeights = new double[]
                {
                        1.0, 0.0, 1.0, 1.0E-4
                };
                ...
                // ======== borderPostProcessingSource ========
                {
                    ...
                    ((GridBagLayout) borderPostProcessingSource.getLayout()).columnWidths = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderPostProcessingSource.getLayout()).rowHeights = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderPostProcessingSource.getLayout()).columnWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ((GridBagLayout) borderPostProcessingSource.getLayout()).rowWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ...
                    borderPostProcessingSource.add(scPostProcessingSource, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0,
                            0));
                }
                pnlPostProcessing.add(borderPostProcessingSource, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                ...
                pnlPostProcessing.add(tbPostProcessing, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
                ...
                // ======== borderPostProcessingTarget ========
                {
                    ...
                    ((GridBagLayout) borderPostProcessingTarget.getLayout()).columnWidths = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderPostProcessingTarget.getLayout()).rowHeights = new int[]
                    {
                            0, 0
                    };
                    ((GridBagLayout) borderPostProcessingTarget.getLayout()).columnWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ((GridBagLayout) borderPostProcessingTarget.getLayout()).rowWeights = new double[]
                    {
                            1.0, 1.0E-4
                    };
                    ...
                    borderPostProcessingTarget.add(scPostProcessingTarget, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0,
                            0));
                }
                pnlPostProcessing.add(borderPostProcessingTarget, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
            }
            tdbMain.addTab("Nachbearbeitung", pnlPostProcessing);
        }
        contentPane.add(tdbMain, new GridBagConstraints(0, 1, 3, 3, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

        // ---- pgMain ----
        pgMain.setStringPainted(true);
        contentPane.add(pgMain, new GridBagConstraints(0, 4, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
