...
public abstract class AbstractTreeTableModel implements MyTreeTableModel
{
    ...
    private void fireTreeNode(int changeType, Object source, Object[] path, int[] childIndices,
            Object[] children)
    {
